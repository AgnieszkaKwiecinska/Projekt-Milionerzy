...
public class Minecraft {
    ...
    public Question getQuestion(int numberQuestion) {
        switch (numberQuestion) {
            case 1: {
                List<String> answers = Arrays.asList("1) Żelazny", "Kamienny", "Złoty", "Diamentowy");
                return new Question("Jaki kilof jest wymagany aby wydobyć rudę złota?",
                        answers,
                        1);
            }
            case 2: {
                List<String> answers = Arrays.asList("1) Ubisoft", "Mojang", "Microsoft ", "Electronic Arts");
                return new Question("Jaki producent wydał Minecrafta?",
                        answers,
                        2);
            }
            case 3: {
                List<String> answers = Arrays.asList("1) 5", "3", "4", "2");
                return new Question("Płomyki stzrelają seriami po ile kul ognia?",
                        answers,
                        2);
            }
            case 4: {
                List<String> answers = Arrays.asList("1) 1.3.1", "1.3.2 ", "1.2.5", "1.2");
